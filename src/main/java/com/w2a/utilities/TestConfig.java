...
public class TestConfig{
	...
	public static String from = "automationengnr@gmail.com";
	public static String password = "Akash@571";
	public static String[] to ={"a4akash91@gmail.com","akash.ece.jsr@gmail.com"};
